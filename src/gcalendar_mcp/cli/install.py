...
Adds gcalendar-mcp to Claude Desktop configuration.
...
def get_package_src_dir() -> Path:
    ...
    # This file is in gcalendar_mcp/cli/install.py
    # Package root is gcalendar_mcp/
...
def copy_package_to_mcp() -> Path:
    """
    Copy gcalendar_mcp package to ~/.mcp/gcalendar/src/.
    
    Returns path to installed package.
    """
    mcp_dir = get_mcp_gcalendar_dir()
    src_dir = mcp_dir / "src" / "gcalendar_mcp"
...
def install_to_claude(name: str = "gcalendar", standalone: bool = True, force: bool = False) -> bool:
    """
    Add gcalendar-mcp to Claude Desktop configuration.
...
def uninstall_from_claude(name: str = "gcalendar", remove_files: bool = False) -> bool:
    """
    Remove gcalendar-mcp from Claude Desktop configuration.
...
def check_installed(name: str = "gcalendar") -> bool:
    """Check if gcalendar-mcp is installed in Claude Desktop."""
    config = load_claude_config()
