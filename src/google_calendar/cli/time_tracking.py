...
def run_time_tracking_command(args: list[str]) -> int:
    ...
    Usage:
        google-calendar-mcp time-tracking enable   - Enable time tracking
        google-calendar-mcp time-tracking disable  - Disable time tracking
        google-calendar-mcp time-tracking status   - Show status
        google-calendar-mcp time-tracking init     - Initialize database
    ...
    if command == "enable":
        ...
        if not is_time_tracking_enabled():
            ...
            print("  Run: google-calendar-mcp time-tracking enable")
...
def _print_usage():
    ...
    print("Usage: google-calendar-mcp time-tracking <command>")
    print()
    print("Commands:")
